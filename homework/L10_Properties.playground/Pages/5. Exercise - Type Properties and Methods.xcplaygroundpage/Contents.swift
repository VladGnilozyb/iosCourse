...
struct User {
    ...
    func logIn(user: User) {
        ...
        print("\(User.currentUser) has been login")
    }
}
var user = User(userName: "vlad", email: "test1", age: 20)
...
//: [Previous](@previous)  |  page 5 of 6  |  [Next: App Exercise - Type Properties and Methods](@next)
